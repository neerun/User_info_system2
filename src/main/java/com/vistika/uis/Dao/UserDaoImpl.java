...
public class UserDaoImpl implements UserDao {
	public static final String SAVE_SQL = " insert into user_info_tbl(user_name,password,mobile_no,is_active,salary)values(?,?,?,?,?)";
	public static final String UPDATE_SQL = "update user_info_tbl set user_name=?, password=?,mobile_no=?,salary=?,is_active=? where id =?";
	public static final String DELETE_SQL = "delete from user_info_tbl where id = ?";
	public static final String LIST_SQL = " select * from user_info_tbl";
	public static final String GET_BY_ID_SQL = "select * from user_info_tbl where id =?";
